				...
				<div class="page-inner mt--5">
                    ...
                    if ($DBE) {
                      ...
                      $DBE2=mysqli_query($conn,"SELECT * from `staff_card` WHERE `card_id`='$card_id'");
	                    ...
	                    $DBE4=mysqli_query($conn,"SELECT * from `staff` WHERE `user_id`='$id'");
                      if ($DBE4) {
                        # code...
								...
								<div class="card-body skew-shadow">
									...
									<div class="row">
										<div class="col-8 pr-0">
											<h3 class="fw-bold mb-1">Staff - <?php echo $todaysate;?></h3>
											<h3 class="fw-bold mb-1"><?php echo $ini.' '.$surname;?></h3>
											<h3 class="fw-bold mb-1"><?php echo $stud_res['staff_number'];?></h3>
											<h3 class="fw-bold mb-1">Office: <?php echo $dddd2['office_number'];?></h3>
								...
								<div class="card-body">
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<div class="px-2 pb-2 pb-md-0 text-center">
											...
											<h1 class="fw-bold mt-3 mb-0">No Staff card created this year</h1>
										</div>
