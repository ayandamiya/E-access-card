      ...
      if (empty($_POST["bus"])) {
        ...
        if (!isset($_SESSION['new_pic'])) {
          ...
          try {
              ...
              //echo($re);
              if (getmatch_score($re)<80) {
                // code...
                $ernew_pic = "face does not match, try new angel and sufficient lighting";
                $Tnew_pic=false;
              }else{
                $ernew_pic = "Face match ".getmatch_score($re)."%";
              }
                  ...
                  if(mysqli_query($conn,$sql))
                      {
                        ...
                        if (mysqli_query($conn,$item)) {
                          ...
                          $item2="INSERT INTO `student_card`(`card_id`, `residence`, `bus`) VALUES ('$card_id','$Ores','$Obus')";
                          ...
                          $cmessage.="You have succefully created your student card on the e-access card System .<br> You cant now login.  <a href='".$text."'>Click to view your student card</a> <br><br>Kind Regard<br>e-access card System Team";
						...
						<div class="col-md-6" style="margin:auto;">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Add Student Card</div>
								</div>
