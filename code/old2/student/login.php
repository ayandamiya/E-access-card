    ...
    <body>
        ...
        <?php
            ...
            <form id="loginform" class="form-vertical" action="" method="post">
				 <div class="control-group normal_text"> <h3><img src="img/logo-icon.png" alt="Logo" />Student Login</h3></div>
                    ...
                    if (isset($_POST["recover"])) {
                             ...
                             if (empty($_POST["cpwd"])) {
                               ...
                               if ($Temail&&$Tpwd&&$Tcpwd&&$hashp) {
                                                    ...
                                                    //echo $staffno." ".;
                                                  $sql="Update student set password='$hashp' where email='$email'";
            ...
            <form id="recoverform" action="#" class="form-vertical" method="post">
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right">
                        <button type="submit" name="recover" class="btn btn-info"/>Recover</button>
