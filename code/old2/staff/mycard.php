...
$sql2="SELECT * from staff_card where staff_card_id='$student_card_id'";
...
if ($query) {
    ...
    while ($fac_n=mysqli_fetch_assoc($query)) {
    	...
    	$year=$fac_n['issue_date'];
    	/*$res=$fac_n['residence'];
    	$bus=$fac_n['bus'];*/
    	$pic=$fac_n['photo'];


    	$stud_id=$fac_n['staff_id'];
    	$sql27="SELECT * from staff where staff_id='$stud_id'";
