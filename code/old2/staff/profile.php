        ...
        <?php
            ...
            //$sname=$ssurname=$sdob=$semail=$scellno=$sidno="";
              ...
              if (empty($_POST["cellno"])) {
                ...
                if (!preg_match("/^[0-9]*$/",$cellno)) {
                  ...
                  $Tcellno=false;
                    ...
                    if(strlen($cellno)!=6){
                        $ercellno = "Staff number must be 9 digits";
                        $Tcellno=false;
             ...
             if (empty($_POST["email"])) {
               ...
               if ($Tname&&$Tsurname&&$Temail&&$Tcellno) {
                       
                         $sql="UPDATE staff SET staff_number='$cellno',staff_name='$name',staff_surname='$surname',staff_email='$email',campus='$campus' where staff_id='$id'";
                        if(mysqli_query($conn,$sql))
                            {
                              $_SESSION['email']=$email;
                              $_SESSION['name']=$name;
                              $_SESSION['surname']=$surname;
                              $_SESSION['student_no']=$scellno;
        ...
        <?php
              ...
              if (isset($_POST['pass'])) {
               ...
               if ($Tpwd&&$Tcpwd&&$hashp) {
                       ...
                       $sql="UPDATE staff SET password='$hashp' where staff_id='$id'";
                      if(mysqli_query($conn,$sql))
                          {
