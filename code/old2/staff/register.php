        ...
        <?php
                            ...
                            $name=$surname=$dob=$email=$cellno=$idno=$pwd=$cpwd=$hashp=$ercampus=$campus="";
                              ...
                              if (empty($_POST["cellno"])) {
                                $ercellno = "Staff number is required";
                                $Tcellno=false;
                              } else {
                                ...
                                if (!preg_match("/^[0-9]*$/",$cellno)) {
                                  ...
                                  $Tcellno=false;
                                    ...
                                    if(strlen($cellno)!=6){
                                        $ercellno = "Staff number must be 6 digits";
                                        $Tcellno=false;
                                      ...
                                      if ($difference<0) {
                                        ...
                                        $ercellno = "staff number is not recognised";
                                        $Tcellno=false;
                                      }else{
                                        //$ercellno = $currentYear." - ".$firtn."0".$lasttwo." = ".$difference;
                                        
                                    $query="SELECT * FROM staff WHERE staff_number='$cellno'";
                                  ...
                                  if($rows>0){
                                        $ercellno ="Staff number already registered";
                                        $Tcellno=false;
                                    }
                             ...
                             if (empty($_POST["cpwd"])) {
                               ...
                               if ($Tname&&$Tsurname&&$Temail&&$Tcellno&&$Tpwd&&$Tcpwd&&$hashp&&$Tcampus) {
                                          
                                      //echo $staffno." ".;
                                    $sql="INSERT into staff (`staff_name`, `staff_surname`, `staff_email`, `staff_number`, `campus`, `password`)values ('$name','$surname','$email','$cellno','$campus','$hashp')";
         ...
         <div class="control-group normal_text"> <h3><img src="img/logo-icon.png" alt="Logo" />Staff Register</h3></div>
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            ...
                            <input type="text" placeholder="Staff Number" name="cellno" value="<?php echo $cellno;?>" />
                            <br>
