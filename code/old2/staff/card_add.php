...
*/
               ...
               */
               ...
               if ($Timg) {
                      ...
                      $sql2="SELECT * FROM `staff_card` WHERE `staff_id`='$id' AND `issue_date`='$mindate'";
                      ...
                      if($res2)
                        {
                          if (mysqli_num_rows($res2)>0) {
                            ...
                            echo '<script type="text/javascript">alert("You already applied for student card this year."); window.location = "card.php";</script>';
                             ...
                             $sql="INSERT INTO `staff_card`(`staff_id`, `photo`, `issue_date`) VALUES ('$id','$img','$mindate')";
                            if(mysqli_query($conn,$sql))
                                {
                                  $stud_card_no=mysqli_insert_id($conn);
                                  $path = '../qr_code/';
                                  $text = "http://demo.trevail.co.za/staff/mycard.php?s=".$stud_card_no;
                                  ...
                                  $item="UPDATE `staff_card` SET `QR_code`='$file' WHERE `staff_card_id`='$stud_card_no'";
        ...
        <div class="widget-content nopadding">
          <form action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="border-top">
                <div class="card-body">
                    <button type="Submit" class="btn btn-primary" name="send" style="width:100%;">Submit Staff Card Application</button>
                    <hr>
